...
.union(
    CAG.circle({"center":[152.25,-90.33],"radius":2.5})
).union(
    CAG.circle({"center":[115.63,-41.18],"radius":2.5})
).union(
    CAG.circle({"center":[92.37,-41.18],"radius":2.5})
).union(
    CAG.circle({"center":[79.8,-108.25],"radius":2.5})
).union(
    CAG.circle({"center":[57.75,-55],"radius":2.5})
).extrude({ offset: [0, 0, 4] });
}
...
.union(
    CAG.circle({"center":[152.25,-90.33],"radius":1.5})
).union(
    CAG.circle({"center":[115.63,-41.18],"radius":1.5})
).union(
    CAG.circle({"center":[92.37,-41.18],"radius":1.5})
).union(
    CAG.circle({"center":[79.8,-108.25],"radius":1.5})
).union(
    CAG.circle({"center":[57.75,-55],"radius":1.5})
).extrude({ offset: [0, 0, 4] });
}
                ...
                let bottom_case__part_3 = _holes_case_fn();
